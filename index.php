<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO user(nome,CPF,senha)
        VALUE ('$nome','$CPF','$senha')");
...
<body>
    ...
    <div class="box">
        <form action="index.php" method="POST">
                ...
                <br>
                <div class="inputBox">
                    <input type="tel" name="CPF" id="CPF" class="input" placeholder="Telefone" required>
                </div>
                <br>
                <div class="inputBox">
                    <input type="password" name="senha" id="senha" class="input" placeholder="E-mail">
                </div>
                <br>
